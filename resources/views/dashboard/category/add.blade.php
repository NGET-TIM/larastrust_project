...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="container-fluid pr-15 pl-15">
            ...
            <form class="custom_form" method="post" enctype="multipart/form-data" action="{{ route('category.store') }}">
                @csrf
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <button type="submit" class="btn btn_logo btn-sm">Add Category</button>
                    </div>
                </div>
            </form>
        </div>
