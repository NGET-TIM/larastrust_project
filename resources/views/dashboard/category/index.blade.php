                ...
                <div class="box-icon remove_icon_dropleft">
                    <div class="btn-group dropleft">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('category.create') }}"><i class="nav-icon fa fa-plus"></i> Add Category</a>
                            <a class="dropdown-item delete_categories_checked"><i class="nav-icon fa fa-trash"></i> Delete Categories</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="role_permissions_table">
                        <form id="list_category_table_form">
                            @csrf
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        data: $('#list_category_table_form').serialize(),
                        dataType: 'json',
                        success: function(response) {
                            if (response.status) {
                                Swal.fire({
