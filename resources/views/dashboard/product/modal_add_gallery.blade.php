<div class="modal fade" id="modal_add_gallery" tabindex="-1" aria-labelledby="modal_add_galleryLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal_add_galleryLabel">{{ $modal_title }}</h5>
