                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="mobile_number" id="mobile_number" value="{{ $user->mobile_number }}" data-inputmask-mask="(999) 999-9999">
                                ...
                                <div class="card-body">
                                    ...
                                    @foreach($roles as $role)
                                        ...
                                        <div class="radio icheck-info">
                                            <input type="radio" name="user_role" {{ $is_selected }} value="{{ $role->id }}" id="supper_admin_{{ $role->id }}" />
